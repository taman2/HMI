...
volatile uinteg8_t UB_Rotary_Button_Current_State=0;
...
void Rotary_Encoder_Ok_IsPressed(void)
{
	...
	if (UB_Rotary_Button_Current_State==1)
	UB_Rotary_Button_Current_State=0;
	else if(UB_Rotary_Button_Current_State==0)
	UB_Rotary_Button_Current_State=1;
}